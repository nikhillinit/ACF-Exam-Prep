# A10: Options Theory - Quick Reference Guide

## Overview
**Tier**: 2 (MEDIUM Priority) | **Time Budget**: 12 min | **Points**: 10-20 | **Exam Weight**: 20%
...
### IDENTIFY (30s)
- Scan for: "call option", "put option", "strike price", "option pricing"
